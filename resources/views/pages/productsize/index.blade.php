...
<div class="card">
    <div class="card-header d-flex justify-content-end">
      <a href="{{route('size.create')}}" class="btn btn-primary fs-bold">Add Size</a>
    </div>
    <!-- /.card-header -->
    <div class="card-body">
        ...
        <tbody>
            ...
            @if (isset($sizes) && count($sizes) > 0)
                ...
                <tr>
                    ...
                    <td>{{$size->name}}</td>
                    <td class="d-flex">
                      <a href="{{route('size.edit',$size->id)}}" class="btn btn-primary">
                        <i class="fas fa-edit"></i>
                      </a>
                      <form action="{{route('size.destroy',$size->id)}}" method="POST" class="mx-2">
                        @method('DELETE')
                        @csrf
